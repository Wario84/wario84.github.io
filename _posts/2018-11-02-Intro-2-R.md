...
Instruction: Solve this exercises by writting the correct atomic elements and operators to perform each arithmetic operation. 
Rules:
1. These exercise can only evaluate a unique ansewer for each line. 
