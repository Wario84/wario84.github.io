...
Operators are the building blocks of the language, they are special characters that perform an action with a specific result. They help us to manipulate variables, evaluate statements, construct
