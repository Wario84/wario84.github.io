...
1. Similar to math, *chunks* of code are read and evaluated from *left* to *right*.
2. Similar to a book, *chunks* of code are read and evaluated from *top* to *botton*.
